...
buildscript {
    ...
    dependencies {
        ...
        // classpath("com.github.recloudstream:gradle:master-1d1a3e3")
        // classpath("com.github.sarapcanagi:Pitipitii:-SNAPSHOT")
...
subprojects {
    ...
    cloudstream {
        ...
        setRepo(System.getenv("MY_GITHUB_REPOSITORY") ?: "https://github.com/sarapcanagi/Pitipitii")

        authors = listOf("sarapcanagi")
    }

    android {
        namespace = "com.sarapcanagi"
